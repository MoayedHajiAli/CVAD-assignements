...
parser.add_argument('--ex_file_path', type=str, help="Path of ex files", default='/userfiles/eozsuer16/argo/ex_list')
parser.add_argument('--val_ex_file_path', type=str, default='/userfiles/eozsuer16/argo/eval.ex_list',
...
def train(model, iter_bar, optimizer, rank, dataset, main_device, args, logger, i_epoch):
    ...
    logger.info(f"Epoch train loss = {total_loss/len(iter_bar):.5f}")
